...
def render():
    ...
    with st.expander("ส่วนที่ 2: ความเป็นไปได้ของการได้รับสัมผัส", expanded=True):
        ...
        col1, col2, col3 = st.columns(3)
        form_data['อ่านฉลาก'] = col1.radio("2.6 ได้อ่านฉลากหรือไม่:", ["ใช่", "ไม่ใช่"])
        form_data['ใส่หน้ากาก'] = col2.radio("2.7 ใส่หน้ากาก/ผ้าปิดจมูกหรือไม่:", ["ใช่", "ไม่ใช่"])
        form_data['สวมถุงมือ'] = col3.radio("2.8 สวมถุงมือยางหรือไม่:", ["ใช่", "ไม่ใช่"])
        form_data['สวมเสื้อผ้าแขนยาว'] = col1.radio("2.9 สวมเสื้อแขนยาว/กางเกงขายาวหรือไม่:", ["ใช่", "ไม่ใช่"])
        form_data['สวมรองเท้าบู๊ท'] = col2.radio("2.10 สวมรองเท้าบู๊ทยางหรือไม่:", ["ใช่", "ไม่ใช่"])
        form_data['ถอดเสื้อผ้าทันที'] = col3.radio("2.11 ถอดเสื้อผ้าทันทีหลังทำงานหรือไม่:", ["ใช่", "ไม่ใช่"])
